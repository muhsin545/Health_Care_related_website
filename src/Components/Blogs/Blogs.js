...
const Blogs = () => {
    return (
        <div style={{ color: "darkcyan" }}>
            <h1 className='my-5 text-center text-uppercase fw-bold'>Blogs</h1>
            <div class="row row-cols-1 row-cols-md-2 mx-auto g-4 my-5 container">
                ...
                <div class="col text-center ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold text-uppercase">Corona Virus Death Update in Bangladesh and New affected...</h5>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold text-uppercase">Russia orders tech platforms to remove coronavirus “fake news”</h5>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold text-uppercase">Germany, France, Italy and Spain halt use of AstraZeneca vaccine</h5>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold text-uppercase">Precision health: Predicting and preventing disease — not just treating it</h5>
