    ...
    return (
        <div>
            ...
            <div className='mx-auto row my-5 text-center container'>
                ...
                <div className="col-md-3 deperment  border rounded-3">
                    <img src={logo9} alt="" />
                ...
                <div className="col-md-3 deperment border rounded">
                    <img src={logo7} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo8} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"> <img src={logo3} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"> <img src={logo4} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo5} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo6} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo10} alt="" /><h4 className='departmentTitle'>Pediatrics</h4>
                    <p>Our paediatrics department is proud of their successful record in giving children a healthy start in life</p></div>
                <div className="col-md-3 deperment border rounded"><img src={logo11} alt="" />
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo12} alt="" /><h4 className='departmentTitle'>Orthopedics</h4>
                    <p>Our Orthopaedics doctor are fully capable in serving the best medical treatment.</p></div>

                <div className="col-md-3 deperment border rounded"><img src={logo13} alt="" /><h4 className='departmentTitle'>Physical Medicine</h4>
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo14} alt="" /><h4 className='departmentTitle'>Surgery</h4>
                ...
                <div className="col-md-3 deperment border rounded"><img src={logo15} alt="" /><h4 className='departmentTitle'>Dermatology</h4>
                    <p>Our dermatology team is able to treat patients with state-of-the-art topical, light and systemic drug therapies.</p></div>
                <div className="col-md-3 deperment border rounded"><img src={logo16} alt="" /><h4 className='departmentTitle'>Nephrology</h4>
